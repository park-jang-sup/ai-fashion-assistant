...
class AgentPlanner {
  ...
  static Future<bool> _prepareRecommendationFor(
    ...
    final entry = RecommendationEntry(
      ...
      candidateFormalityScores: outcome.candidateFormalityScores,
      candidateColorHarmonyScores: outcome.candidateColorHarmonyScores,
      candidateStyleScores: outcome.candidateStyleScores,
